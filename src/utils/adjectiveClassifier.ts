...
const ADJECTIVE_DATABASE: Record<AdjectiveCategory, string[]> = {
  opinion: [
    ...
    // Extended opinion adjectives from GitHub list
    'abandoned', 'abhorrent', 'abject', 'abominable', 'abrasive', 'abrupt', 'abscessed', 'abstemious', 'abstinent',
    'abstract', 'abstruse', 'absurd', 'abundant', 'abusive', 'abuzz', 'abysmal', 'acceptable', 'accessible',
    'accommodating', 'accomplished', 'accountable', 'accurate', 'accursed', 'accusatory', 'ace', 'acerbic',
    'achromatic', 'acidic', 'acidulous', 'acid', 'acoustic', 'acquiescent', 'acquisitive', 'acrid', 'acrimonious',
    'acrobatic', 'active', 'acute', 'adamant', 'adaptable', 'addictive', 'adept', 'adequate', 'adhesive',
    'admirable', 'admissible', 'adorable', 'adroit', 'adulterous', 'advanced', 'advantageous', 'adventurous',
    'adverse', 'advisable', 'affable', 'affected', 'affecting', 'affectionate', 'affirmative', 'affluent',
    'affordable', 'afraid', 'ageless', 'aggressive', 'aghast', 'agile', 'agleam', 'aglitter', 'aglow',
    'agnostic', 'agog', 'agonizing', 'agreeable', 'ailing', 'aimless', 'airborne', 'airless', 'airsick',
    'airtight', 'airworthy', 'airy', 'akin', 'alarmist', 'alcoholic', 'alert', 'algorithmic', 'alien',
    'alive', 'alkaline', 'alleged', 'allegorical', 'allergic', 'allied', 'alliterative', 'allowable',
    'alluring', 'allusive', 'almighty', 'aloof', 'alphabetical', 'alterable', 'alternative', 'altruistic',
    'amateur', 'amazed', 'amazing', 'ambidextrous', 'ambient', 'ambiguous', 'ambitious', 'ambivalent',
    'amenable', 'amiable', 'amicable', 'amnesiac', 'amoral', 'amorous', 'amorphous', 'amphibious',
    'ample', 'amused', 'amusing', 'anachronistic', 'anaemic', 'anaerobic', 'analgesic', 'analogous',
    'analytic', 'anarchic', 'ancestral', 'ancient', 'ancillary', 'androgynous', 'anecdotal', 'anemic',
    'anesthetic', 'angelic', 'angry', 'anguished', 'angular', 'animated', 'animistic', 'anniversary',
    'annoying', 'annual', 'anomalous', 'anonymous', 'answerable', 'antagonistic', 'antecedent', 'antique',
    'antiseptic', 'antisocial', 'antithetical', 'anxious', 'apathetic', 'apocalyptic', 'apocryphal',
    'apologetic', 'apoplectic', 'appalling', 'apparent', 'appealing', 'appetizing', 'applicable',
    'appreciable', 'appreciative', 'apprehensive', 'approachable', 'appropriate', 'approximate', 'apt',
    'aquatic', 'arable', 'arbitrary', 'arboreal', 'arcane', 'archaeological', 'archaic', 'arched',
    'architectural', 'arctic', 'ardent', 'arduous', 'arguable', 'argumentative', 'arid', 'aristocratic',
    'armed', 'armored', 'aromatic', 'arrant', 'arresting', 'arrogant', 'arterial', 'artful', 'arthritic',
    'articulate', 'artificial', 'artistic', 'artless', 'ascendant', 'ascetic', 'aseptic', 'asexual',
    'ashamed', 'ashen', 'ashy', 'asinine', 'askance', 'askew', 'asleep', 'asocial', 'aspirant',
    'assailable', 'assertive', 'assiduous', 'associate', 'assorted', 'assumed', 'assuming', 'assured',
    'asthmatic', 'astigmatic', 'astir', 'astonishing', 'astounding', 'astral', 'astringent', 'astrological',
    'astronomical', 'astute', 'asymmetric', 'atavistic', 'atheistic', 'athletic', 'atmospheric', 'atomic',
    'atonal', 'atrocious', 'atrophied', 'attached', 'attainable', 'attendant', 'attentive', 'attenuate',
    'attested', 'attired', 'attractive', 'attributable', 'atypical', 'audacious', 'audible', 'audiovisual',
    'auditory', 'augmented', 'august', 'aural', 'auspicious', 'austere', 'authentic', 'authoritarian',
    'authoritative', 'autistic', 'autobiographical', 'autocratic', 'automatic', 'automotive', 'autonomous',
    'autumnal', 'auxiliary', 'available', 'avaricious', 'average', 'averse', 'avian', 'avid', 'avoidable',
    'avowed', 'aware', 'awed', 'awesome', 'awful', 'awkward', 'axial', 'axiomatic'
  ],
  size: [
