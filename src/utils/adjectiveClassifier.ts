...
const ADJECTIVE_DATABASE: Record<AdjectiveCategory, string[]> = {
  ...
  purpose: [
    ...
    'rusty', 'tarnished',
    // Extended purpose adjectives from user request
    'abdominal', 'ablative', 'abolition', 'academical', 'academic', 'accessory', 'accusative', 'acoustic',
    'acrobatic', 'acting', 'actuarial', 'additive', 'adenoidal', 'adenoid', 'adiabatic', 'adipose',
    ...
    'algorithmic', 'alimentary', 'allegorical', 'alliterative', 'alluvial', 'alphabetical', 'alphabetic',
    ...
    'bed and breakfast', 'behavioral', 'beneficiary', 'biblical', 'bibliographical', 'bibliographic',
    'bicameral', 'bicuspid', 'bidirectional', 'bifocal', 'bilateral', 'bilingual', 'binary', 'binocular',
    'binomial', 'biochemical', 'biographical', 'biological', 'biomedical', 'bionic', 'bipartisan',
    'bipartite', 'bipedal', 'biped', 'bipolar', 'biracial', 'bisexual', 'bivalve', 'blindfold', 'block front',
    'bobtail', 'bodily', 'bold face', 'boldface', 'bomb', 'bookmaking', 'botanical', 'bovine', 'bridal',
    'broad gauge', 'broadband', 'broadcast', 'bronchial', 'budgetary', 'bull', 'bumper', 'bureaucratic',
    'burlesque', 'bush', 'calisthenic', 'caloric', 'calorific', 'camp', 'canine', 'cannonball', 'canonical',
    'capillary', 'capitalistic', 'capitalist', 'capital', 'cardiac', 'cardinal', 'cardiovascular',
    'carnivorous', 'carotid', 'castor', 'catalytic', 'categorical', 'cathartic', 'catholic', 'caudal',
    'causal', 'causative', 'cautionary', 'celebratory', 'celestial', 'cellular', 'centigrade', 'centrifugal',
    'centripetal', 'cephalic', 'cerebral', 'ceremonial', 'cervical', 'cetacean', 'childbearing', 'chin',
    'choral', 'choreographic', 'chronological', 'cinematic', 'circadian', 'circulatory', 'circumflex',
    'civic', 'clarion', 'classical', 'clerical', 'climactic', 'climatic', 'clinical', 'clitoral', 'coastal',
    'coeducational', 'cognate', 'cognitive', 'coital', 'collegiate', 'colloquial', 'colonialism',
    'colonialist', 'colonial', 'combatant', 'combustion', 'comedic', 'commemorative', 'commercial',
    'common sense', 'communicant', 'communistic', 'communist', 'commutative', 'comparative', 'compensatory',
    'complementary', 'component', 'computational', 'concatenate', 'conceptual', 'concubine', 'confederate',
    'confessional', 'confirmatory', 'confiscate', 'conglomerate', 'congratulatory', 'congregate',
    'congregational', 'congressional', 'coniferous', 'conjugal', 'conjugated', 'conjugate', 'conjunctive',
    'conjuring', 'connective', 'connotative', 'connubial', 'consecrate', 'conservatory', 'constabulary',
    'constituent', 'constitutional', 'consular', 'consultative', 'consulting', 'consumerism', 'contextual',
    'continent', 'contraband', 'contraceptive', 'contractual', 'contralto', 'contrapuntal', 'contributory',
    'convalescence', 'conversational', 'convict', 'coordinate', 'copyright', 'corneal', 'corollary',
    'coronary', 'corporal', 'corporate', 'corporeal', 'correctional', 'corrective', 'correlate',
    'correlative', 'correspondent', 'corroborate', 'corroborative', 'cortical', 'cosignatory', 'cosmetic',
    'cosmic', 'cosmological', 'counterrevolutionary', 'counter', 'county', 'cranial', 'credential',
    'crematory', 'crescendo', 'criminal', 'crosstown', 'crustacean', 'crystallographic', 'culinary',
    'cultural', 'cuneiform', 'curative', 'cursive', 'custodial', 'custom', 'cybernetic', 'cyclic',
    'cyclone', 'cyclonic', 'dactylic', 'dative', 'deal', 'decentralize', 'deciduous', 'decimal',
    'declamatory', 'declarative', 'decongestant', 'decorative', 'deductive', 'defeatism', 'defendant',
    ...
    'determinant', 'determinism', 'deterministic', 'deterrent', 'devolution', 'devotional', 'diacritical',
    'diacritic', 'diagnostic', 'diagrammatic', 'dialectal', 'dialectic', 'diametrical', 'diastolic',
    ...
    'documentary', 'domestic', 'door to door', 'dorsal', 'double bass', 'double flat', 'double sharp',
    'downstage', 'downstate', 'downtown', 'dramatic', 'drinking', 'ducal', 'duodenal', 'duplex', 'dyadic',
    'dynastic', 'ecclesiastical', 'ecclesiastic', 'ecliptic', 'ecological', 'econometric', 'economic',
    'ecumenical', 'editorial', 'educational', 'effluent', 'electioneer', 'elective', 'electoral',
    'electrical', 'electric', 'electrolytic', 'electromagnetic', 'electronic', 'electroplate', 'electrostatic',
    ...
    'equestrian', 'equine', 'equinoctial', 'erectile', 'ergonomic', 'erogenous', 'erotically', 'erotic',
    'erythrocyte', 'escapism', 'esthetic', 'ethic', 'ethnological', 'etymological', 'eulogistic',
    'euphemistic', 'eutectic', 'evangelical', 'evangelistic', 'eviscerate', 'evolutionary', 'ex works',
    'exclamatory', 'excommunicate', 'excretory', 'executable', 'executive', 'existentialist', 'existential',
    'expectorant', 'expedite', 'expeditionary', 'experimental', 'explanatory', 'expletive', 'exploratory',
    'exponential', 'exponent', 'expository', 'expressionism', 'express', 'extensional', 'extracurricular',
    'extramarital', 'extrasensory', 'facial', 'factional', 'factorial', 'faecal', 'fairy', 'familial',
    'farrow', 'fascist', 'fecal', 'federalism', 'federalist', 'federal', 'federate', 'feline', 'felon',
    'female', 'feminine', 'feminism', 'femoral', 'fermentation', 'festal', 'fetal', 'feudalistic', 'feudal',
    'fibroid', 'fictional', 'fiduciary', 'figurative', 'filial', 'financial', 'first class', 'first string',
    'fiscal', 'fixative', 'flagellate', 'floral', 'flying', 'fly', 'focal', 'foetal', 'foldaway', 'folio',
    'folklore', 'fondu', 'for the person', 'forehand', 'forensic', 'formative', 'fornicate', 'forte',
    'fortissimo', 'foster', 'fractional', 'fraternal', 'free form', 'free hand', 'free on board', 'freebie',
    'freehand', 'freehold', 'freethinker', 'freewill', 'frontal', 'fully fashioned', 'functional',
    'functionary', 'fundamentalism', 'fundamentalist', 'fungal', 'fungicidal', 'fungous', 'funicular',
    'future perfect', 'galactic', 'galvanic', 'gastric', 'gastrointestinal', 'gastronomical', 'gastronomic',
    'gauge', 'genealogical', 'generative', 'genetic', 'genital', 'genitive', 'gentile', 'geocentric',
    'geodesic', 'geographical', 'geologic', 'geophysical', 'geopolitical', 'geothermal', 'geriatric',
    'germicidal', 'germinal', 'gimlet', 'glacial', 'gladiatorial', 'glandular', 'globetrotter',
    'government issue', 'governmental', 'gradient', 'grammatical', 'gravitational', 'guardian',
    'gubernatorial', 'guns', 'gustatory', 'guttural', 'gymnastic', 'gynaecological', 'gynecological',
    'gyrate', 'hallucinogenic', 'hard core', 'hard hat', 'hardback', 'hardcover', 'harlequin', 'harlot',
    'harmonic', 'healing', 'heathen', 'hepatic', 'heraldic', 'herbaceous', 'herbal', 'herbivorous',
    'hereditary', 'hermaphroditic', 'heterosexual', 'heuristic', 'hierarchical', 'hieroglyphic',
    'historical', 'historic', 'homemaker', 'homeopathic', 'hometown', 'homoeopathic', 'homosexual',
    'honorific', 'honour', 'hormonal', 'horticultural', 'humanistic', 'humanitarian', 'humanoid', 'human',
    'hybrid', 'hydraulic', 'hydroelectric', 'hydroponic', 'hymnal', 'hyperbolic', 'hypnotic', 'hypodermic',
    'iambic', 'idiomatic', 'iguana', 'illuminate', 'illustrative', 'imperialistic', 'imperialist',
    'imperial', 'impressionistic', 'impressionist', 'in camera', 'in posse', 'inaugural', 'incarcerate',
    'incentive', 'indicative', 'indoor', 'inductive', 'industrial', 'inertial', 'inferential', 'infidel',
    'inflationary', 'inflectional', 'informational', 'informative', 'inform', 'inhalant', 'initiate',
    'initiative', 'insectivorous', 'inspirational', 'institutional', 'instructional', 'instructive',
    'instrumentalist', 'instrumental', 'insurrection', 'integral', 'integrate', 'intellectualism',
    'intellectual', 'interactive', 'intercollegiate', 'intercontinental', 'interdenominational',
    'interdepartmental', 'interdisciplinary', 'interfaith', 'intergalactic', 'interlocutory',
    'intermediary', 'international', 'intern', 'interoffice', 'interpersonal', 'interplanetary',
    'interpretative', 'interpretive', 'interracial', 'interrogative', 'interrogatory', 'interscholastic',
    'interstate', 'interstellar', 'interurban', 'intestate', 'intestinal', 'intoxicant', 'intramural',
    'intransitive', 'intravenous', 'introductory', 'invective', 'inverse', 'invertebrate', 'investigative',
    'invitational', 'irritant', 'isolationism', 'isometric', 'isomorphic', 'isotopic', 'isotropic',
    'italic', 'iterative', 'itinerary', 'jack', 'janitorial', 'jetty', 'jingoism', 'journalistic',
    'judicial', 'judiciary', 'jugular', 'julienne', 'juridical', 'jury', 'kid glove', 'kinematic',
    'kinetic', 'knock down', 'kosher', 'labial', 'lace up', 'lachrymal', 'lacrimal', 'landowner', 'lane',
    'lap joint', 'lapidary', 'larboard', 'largo', 'lateral', 'latitudinal', 'laureate', 'lawbreaker',
    'lawgiver', 'laxative', 'left wing', 'leftist', 'legalism', 'legalistic', 'legal', 'legislative',
    'leguminous', 'leonine', 'lesbian', 'lexical', 'liberalism', 'liberal', 'libertarian', 'liege',
    'lifesaving', 'light face', 'lineal', 'lingual', 'linguistic', 'literal', 'literary', 'lithographic',
    'litigant', 'littoral', 'liturgical', 'livery', 'locomotive', 'logarithmic', 'logistic', 'longitudinal',
    'lower case', 'lower class', 'lowland', 'lubricant', 'lumbar', 'luminary', 'lunar', 'lupine',
    'lymphatic', 'lyrical', 'lyric', 'machine readable', 'macrobiotic', 'magnetic', 'malarial', 'male',
    'malfeasance', 'mammalian', 'mammary', 'managerial', 'managing', 'mandible', 'manorial', 'manual',
    'marine', 'marital', 'maritime', 'marsupial', 'martial', 'masculine', 'masonic', 'mastoid',
    'matchmaker', 'matchmaking', 'maternal', 'mathematical', 'matriarchal', 'matrimonial', 'matter in deed',
    'matter of course', 'matter of fact', 'maxillary', 'mayoral', 'meaning', 'mechanical', 'mechanistic',
    'medal', 'medial', 'median', 'mediate', 'medical', 'medicinal', 'melodic', 'memorial', 'menopausal',
    'menstrual', 'mental', 'mercantile', 'meridian', 'metabolic', 'metacarpal', 'metamorphic',
    'metaphorical', 'metaphysical', 'metatarsal', 'meteorological', 'metrical', 'metric', 'metropolitan',
    'middle class', 'migratory', 'military', 'mimetic', 'mimic', 'minim', 'minion', 'ministerial',
    'ministrant', 'missive', 'mizzen', 'mnemonic', 'modal', 'modernism', 'modernistic', 'modular', 'molar',
    'molecular', 'monarchical', 'monarchist', 'monarch', 'monastic', 'monaural', 'monetary', 'monger',
    'monogamous', 'monolingual', 'monophonic', 'monopolistic', 'monosyllabic', 'monotheism', 'monotheistic',
    'monotone', 'monotonic', 'mono', 'morphological', 'mortuary', 'motile', 'motivational', 'motive',
    'motor', 'mountaintop', 'mourning', 'mucous membrane', 'mucous', 'multidimensional', 'multilateral',
    'multilingual', 'multinational', 'multiplex', 'multiplicative', 'multipurpose', 'multiracial',
    'multivariate', 'municipal', 'mural', 'muscular', 'musical', 'mutant', 'mystical', 'mystic',
    'mythical', 'mythological', 'narcotic', 'narrative', 'narrow gauge', 'nasal', 'natal', 'nationalism',
    'nationalist', 'national', 'nationwide', 'naturalistic', 'nautical', 'naval', 'navigational', 'neural',
    'neuron', 'neuter', 'nihilism', 'nihilistic', 'nihilist', 'nocturnal', 'nodal', 'nodular', 'noisemaker',
    'nominate', 'nominative', 'noncommercial', 'nondeductible', 'nondenominational', 'nonexempt',
    'nongovernmental', 'nonhuman', 'nonindustrial', 'nonintervention', 'nonliving', 'nonobjective',
    'nonpartisan', 'nonphysical', 'nonpolitical', 'nonprofessional', 'nonprofit', 'nonrepresentational',
    'nonresident', 'nonseasonal', 'nonsectarian', 'nonsmoking', 'nontaxable', 'nontechnical', 'nonunion',
    'nonverbal', 'nonvoting', 'normative', 'notional', 'nuclear', 'nudist', 'numeral', 'numerical',
    'numeric', 'nuptial', 'nutrient', 'nutritive', 'nymphomaniac', 'nymphomania', 'obstetric', 'occlusive',
    'occult', 'occupational', 'oceanic', 'oceanographic', 'octal', 'octave', 'ocular', 'off line',
    'off season', 'official', 'offstage', 'olfactory', 'oligarchic', 'omnibus', 'omnivorous', 'on line',
    'on stream', 'operatic', 'operational', 'operative', 'ophthalmic', 'opiate', 'opponent', 'optical',
    'optic', 'oral', 'oratorical', 'orchestral', 'ordinal', 'organisational', 'organizational', 'orgasmic',
    'ornamental', 'orthodontics', 'orthodontic', 'orthographic', 'orthopedic', 'outdoor', 'ovarian',
    'oviparous', 'paediatric', 'pagan', 'palatal', 'palimpsest', 'palindromic', 'palliative', 'palpate',
    'pancreatic', 'pandemic', 'panoramic', 'pantheistic', 'pan', 'papal', 'paperback', 'paradigmatic',
    'parallelism', 'paramedical', 'paramedic', 'paramilitary', 'paraprofessional', 'parental',
    'parenthetic', 'parliamentarian', 'parliamentary', 'parochial', 'participant', 'participial',
    'particulate', 'party', 'parvenu', 'paschal', 'past perfect', 'pastoral', 'paternalism', 'paternal',
    'patriarchal', 'patrician', 'patrimonial', 'patronymic', 'payoff', 'pectoral', 'pecuniary',
    'pedagogic', 'pedal', 'peddling', 'pedestrian', 'pediatric', 'peekaboo', 'pelagic', 'pelvic', 'penal',
    'pendant', 'penile', 'peninsular', 'penitential', 'penitentiary', 'pentameter', 'peptic', 'percent',
    'perceptual', 'perfectionist', 'performing', 'periodical', 'periodontal', 'persons', 'phallic',
    'pharmaceutical', 'pharyngeal', 'philatelic', 'philharmonic', 'philological', 'philosophical',
    'phonemic', 'phonetic', 'phonic', 'phonological', 'photoelectric', 'photographic', 'phrasal',
    'physical', 'physic', 'physiological', 'pianissimo', 'piano', 'picaresque', 'pictorial', 'pinup',
    'piscatorial', 'pistillate', 'pituitary', 'pizzicato', 'placental', 'planetary', 'plenipotentiary',
    'pluperfect', 'pluralism', 'plural', 'pneumatic', 'poetic', 'pointillism', 'polar', 'polemic',
    'political', 'polygamous', 'polyglot', 'polynomial', 'polyphonic', 'polysyllabic', 'polytechnic',
    'polytheistic', 'pontifical', 'populist', 'porcine', 'positional', 'positivism', 'postal',
    'postdoctoral', 'postmortem', 'postoperative', 'postpaid', 'postpartum', 'pragmatism', 'pragmatist',
    'preacher bird', 'precautionary', 'predicate', 'predicative', 'prefatory', 'prehensile', 'premarital',
    'premenstrual', 'prenatal', 'preparatory', 'prepositional', 'prerogative', 'prescriptive',
    'present perfect', 'preservative', 'presto', 'preterite', 'preterit', 'preventive', 'priestly',
    'primate', 'processional', 'procreative', 'professionalism', 'professional', 'prognostic',
    'programmable', 'projectile', 'proletarian', 'promissory', 'promotional', 'propaganda', 'propagandist',
    'propellent', 'prophylactic', 'propitiatory', 'proportional', 'propositional', 'proprietary',
    'prostate', 'protective', 'protoplasmic', 'protozoan', 'proverbial', 'provincial', 'psychedelic',
    'psychiatric', 'psychic', 'psychogenic', 'psychological', 'psychologist', 'psychosomatic', 'pubic',
    'pugilistic', 'pulmonary', 'punitive', 'pupal', 'purgative', 'purgatorial', 'puritan', 'pyrotechnics',
    'pyrotechnic', 'quadratic', 'quadruped', 'qualitative', 'quantitative', 'quick fire', 'rabbinical',
    'racial', 'racing', 'radioactive', 'raglan', 'rapid fire', 'ratio test', 'recessional', 'recessive',
    'recidivism', 'recipient', 'reciprocal', 'recitative', 'recreational', 'rectal', 'recuperative',
    'recursive', 'redirect', 'refer', 'reflexive', 'reflex', 'reformatory', 'refrigerant', 'regenerate',
    'regenerative', 'regent', 'regimental', 'regionalism', 'regional', 'regurgitate', 'reincarnate',
    'reincarnation', 'relational', 'relativistic', 'relaxant', 'religious', 'remedial', 'remunerative',
    'renal', 'rental', 'replicate', 'representational', 'representative', 'reproductive', 'reptile',
    'reptilian', 'republican', 'residential', 'resident', 'respondent', 'restorative', 'restriction',
    'retail', 'retaliatory', 'retardant', 'retirement', 'retributive', 'retrospective', 'reverend',
    'revivalist', 'revolutionary', 'revolutionist', 'rhapsodic', 'rhetorical', 'rhythmical', 'rhythmic',
    'right wing', 'rightist', 'rights', 'ripple', 'ritualistic', 'ritual', 'roasting', 'rococo',
    'roll on', 'roman', 'rotary', 'rotate', 'rotational', 'royalist', 'royal', 'rubric', 'ruling',
    'ruminant', 'rural', 'rustic', 'sabbatical', 'sacerdotal', 'sacramental', 'sacrificial', 'sales',
    'saltwater', 'sandlot', 'sartorial', 'satirical', 'saving', 'saw set', 'scalar', 'scald',
    'scatological', 'scenic', 'schematic', 'scholastic', 'sciatic', 'scientific', 'sclerotic', 'scriptural',
    'seafaring', 'seagoing', 'sebaceous', 'secessionist', 'second class', 'second string', 'secretarial',
    'sectarian', 'sectional', 'secular', 'sedative', 'sedimentary', 'sedition', 'see through', 'seismic',
    'seismographic', 'seismograph', 'selfishness', 'semantic', 'semiautomatic', 'seminal', 'seminary',
    'semiprofessional', 'semitropical', 'senatorial', 'sensory', 'septic', 'serial', 'serous', 'servo',
    'sexism', 'sexual', 'shell shock', 'shortcut', 'shortwave', 'shotgun', 'sibilant', 'sidereal',
    'signal', 'signatory', 'silvan', 'simian', 'simplex', 'simulate', 'sine die', 'singsong', 'ski',
    'sleepwalk', 'slow motion', 'socialistic', 'socialist', 'social', 'societal', 'socioeconomic',
    'solar', 'soldierly', 'soli', 'solo', 'somnambulism', 'sonic', 'southpaw', 'sovereign', 'soviet',
    'spacial', 'spatial', 'speaking', 'spectral', 'spectroscopic', 'spermatozoon', 'spinal', 'spiritualistic',
    'spiritual', 'splint seat', 'sporting', 'staccato', 'stand up', 'standard gauge', 'staple', 'starboard',
    'starlight', 'stateside', 'statewide', 'statistical', 'statuary', 'statutory', 'stellar', 'stenographic',
    'step down', 'step in', 'step up', 'stereophonic', 'stereo', 'stimulant', 'stipulate', 'stochastic',
    'storybook', 'storyteller', 'strategic', 'streetwalker', 'streptococcal', 'stringed', 'structuralist',
    'structural', 'stutter', 'stylistic', 'styptic', 'subconscious', 'subcutaneous', 'subhuman',
    'subjective', 'subject', 'subjunctive', 'sublimate', 'subliminal', 'suborbital', 'subscript',
    'subsidiary', 'subsonic', 'substantive', 'subterranean', 'subtropical', 'suburban', 'sucking',
    'suffragan', 'summary', 'superintendent', 'superscript', 'supersonic', 'supervisory', 'supplemental',
    'supplementary', 'supporting', 'supranational', 'supremacist', 'surgical', 'surrealism', 'sybarite',
    'syllabic', 'syllogistic', 'sylvan', 'symbiotic', 'symbolic', 'symphonic', 'symptomatic', 'synchronous',
    'syncopated', 'synergistic', 'synonymous', 'syntactic', 'systemic', 'tabulate', 'tactical', 'tactile',
    'tail', 'take down', 'take out', 'tandem', 'tangential', 'tangent', 'tarot', 'tattletale',
    'tautological', 'taxable', 'taxonomic', 'technical', 'technocrat', 'telegraphic', 'telepathic',
    'telephonic', 'telescopic', 'temporal', 'tensile', 'terminal', 'terrestrial', 'territorial', 'tertiary',
    'testamentary', 'testate', 'testimonial', 'textual', 'theatrical', 'theism', 'theistic', 'theist',
    'thematic', 'theocratic', 'theological', 'theoretical', 'therapeutic', 'thermal', 'thermionic',
    'thermodynamic', 'thermonuclear', 'thermostatic', 'thinking', 'third class', 'third party', 'thoracic',
    'thyroid', 'tidal', 'tiptoe', 'titular', 'tonal', 'tongue sole', 'tonic', 'tonsorial', 'topical',
    'topographical', 'topographic', 'topological', 'totalitarian', 'totemic', 'tourist', 'traditionalist',
    'transatlantic', 'transcendentalism', 'transcendentalist', 'transcendental', 'transcontinental',
    'transfinite', 'transitional', 'transitive', 'transmutation', 'transnational', 'transoceanic',
    'traverse', 'treble', 'tribalism', 'tribal', 'tributary', 'trigonometric', 'trig', 'trip line',
    'tripartite', 'triumphal', 'tropical', 'tropic', 'troubleshooter', 'tuberous', 'turnover', 'tutorial',
    'twenty questions', 'typesetting', 'typhoid', 'typographic', 'ultrasonic', 'umbilical', 'underarm',
    'undercover', 'underground', 'undersea', 'underwater', 'unicameral', 'unidirectional', 'unilateral',
    'unisex', 'unitary', 'upcountry', 'upgrade', 'upland', 'upper class', 'upstage', 'upstate', 'uptown',
    'urban', 'uterine', 'utilitarian', 'uvular', 'vaginal', 'valedictory', 'variable annuity', 'varicose',
    'vascular', 'vassal', 'vegetarian', 'vegetative', 'vehicular', 'venereal', 'venous', 'ventral',
    'ventricular', 'verbal', 'vernacular', 'vernal', 'vertebral', 'vertebrate', 'veterinary', 'vice',
    'villager', 'vinaigrette', 'viral', 'virtuosity', 'visceral', 'visual', 'vivace', 'vixen', 'vocalic',
    'vocal', 'vocational', 'vocative', 'voiced', 'volcanic', 'voltaic', 'voluptuary', 'votary', 'votive'
  ]
};

const ADVERB_DATABASE: Record<AdverbCategory, string[]> = {
  manner: [
    'abjectly', 'ably', 'abnormally', 'abominably', 'abruptly', 'absently', 'absolutely', 'abstractedly', 'abstractly', 'abstrusely',
    'absurdly', 'abundantly', 'abusively', 'abysmally', 'academically', 'acceptably', 'accessibly', 'accidentally', 'accordingly', 'accurately',
    'accusingly', 'acidly', 'acoustically', 'actively', 'actually', 'acutely', 'adeptly', 'adequately', 'adjacently', 'administratively',
    'admirably', 'admiringly', 'adorably', 'adoringly', 'adroitly', 'advantageously', 'adventurously', 'adversely', 'advisedly', 'aerodynamically',
    'aesthetically', 'affably', 'affectionately', 'affirmatively', 'affluently', 'aggressively', 'agilely', 'agonisingly', 'agonizingly', 'agreeably',
    'aimlessly', 'airily', 'alarmingly', 'alertly', 'algebraically', 'allegorically', 'allusively', 'alphabetically', 'alternately', 'alternatively',
    'altruistically', 'amazingly', 'ambidextrously', 'ambiguously', 'ambitiously', 'amiably', 'amicably', 'amorally', 'amorously', 'amorphously',
    'amply', 'amusingly', 'analogously', 'analytically', 'anarchically', 'anatomically', 'angelically', 'angrily', 'animatedly', 'annoyingly',
    'anonymously', 'antagonistically', 'antiseptically', 'antithetically', 'anxiously', 'apathetically', 'apologetically', 'appallingly', 'apparently', 'appetizingly',
    'appreciably', 'appreciatively', 'apprehensively', 'appropriately', 'approvingly', 'approximately', 'aptly', 'arbitrarily', 'archaically', 'architecturally',
    'archly', 'ardently', 'arduously', 'aristocratically', 'arithmetically', 'arrogantly', 'artfully', 'articulately', 'artificially', 'artistically',
    'artlessly', 'asexually', 'ashamedly', 'assertively', 'assiduously', 'assuredly', 'astonishingly', 'astoundingly', 'astronomically', 'astutely',
    'asymmetrically', 'asymptotically', 'asynchronously', 'athletically', 'atmospherically', 'atrociously', 'attentively', 'attractively', 'attributively', 'atypically',
    'audaciously', 'audibly', 'aurally', 'auspiciously', 'austerely', 'authentically', 'authoritatively', 'autocratically', 'automatically', 'autonomously',
    'avariciously', 'avidly', 'avoidably', 'avowedly', 'awesomely', 'awfully', 'awkwardly', 'axiomatically', 'badly', 'baldly',
    'balefully', 'barbarously', 'barely', 'basely', 'bashfully', 'basically', 'bawdily', 'beastly', 'beauteously', 'beautifully',
    'becomingly', 'begrudgingly', 'belatedly', 'belligerently', 'beneficently', 'beneficially', 'benevolently', 'benignly', 'bitingly', 'bitterly',
    'bizarrely', 'blamelessly', 'blandly', 'blankly', 'blasphemously', 'blatantly', 'bleakly', 'blearily', 'blessedly', 'blindingly',
    'blindly', 'blissfully', 'blithely', 'bloodlessly', 'bluntly', 'boastfully', 'bodily', 'boisterously', 'boldly', 'boorishly',
    'bountifully', 'boyishly', 'brashly', 'bravely', 'brazenly', 'breathlessly', 'breezily', 'briefly', 'brightly', 'brilliantly',
    'briskly', 'broadly', 'brotherly', 'brusquely', 'brutally', 'brutishly', 'buoyantly', 'bureaucratically', 'busily', 'cagily',
    'callously', 'calmly', 'candidly', 'cantankerously', 'capably', 'capaciously', 'capriciously', 'carefully', 'carelessly', 'carnally',
    'casually', 'catastrophically', 'categorically', 'cattily', 'causally', 'caustically', 'cautiously', 'ceaselessly', 'censoriously', 'centrally',
    'ceremonially', 'ceremoniously', 'certainly', 'chaotically', 'characteristically', 'charily', 'charitably', 'charmingly', 'chastely', 'chattily',
    'cheaply', 'cheekily', 'cheerfully', 'cheerily', 'cheerlessly', 'chemically', 'chiefly', 'childishly', 'chivalrously', 'choppily',
    'chronically', 'chronologically', 'churlishly', 'circuitously', 'circumstantially', 'civilly', 'clandestinely', 'classically', 'cleanly', 'clearly',
    'cleverly', 'clinically', 'closely', 'clownishly', 'clumsily', 'coarsely', 'cockily', 'cogently', 'coherently', 'cohesively',
    'coincidentally', 'coldly', 'collectively', 'colloquially', 'colorfully', 'colossally', 'colourfully', 'comfortably', 'comfortingly', 'comically',
    'commendably', 'commercially', 'commonly', 'communally', 'compactly', 'comparably', 'comparatively', 'compassionately', 'compatibly', 'compellingly',
    'competently', 'competitively', 'complacently', 'complaisantly', 'completely', 'comprehensively', 'compulsively', 'compulsorily', 'conceivably', 'concentrically',
    'conceptually', 'concisely', 'conclusively', 'concretely', 'concurrently', 'condescendingly', 'conditionally', 'confessedly', 'confidentially', 'confidently',
    'confusedly', 'confusingly', 'congenially', 'congenitally', 'conscientiously', 'consciously', 'consecutively', 'consequently', 'conservatively', 'considerably',
    'considerately', 'consistently', 'conspicuously', 'constantly', 'constitutionally', 'constructively', 'contemporaneously', 'contemptibly', 'contemptuously', 'contentedly',
    'contentiously', 'continually', 'continuously', 'contractually', 'contrarily', 'contritely', 'controversially', 'conveniently', 'conventionally', 'conversationally',
    'conversely', 'convincingly', 'convulsively', 'coolly', 'cooperatively', 'copiously', 'cordially', 'correctly', 'correspondingly', 'corruptly',
    'cosily', 'cosmetically', 'cosmically', 'countably', 'courageously', 'courteously', 'covertly', 'covetously', 'coyly', 'cozily',
    'craftily', 'crassly', 'cravenly', 'crazily', 'creatively', 'credibly', 'creditably', 'credulously', 'creepily', 'criminally',
    'crisply', 'critically', 'crookedly', 'crossly', 'crucially', 'crudely', 'cruelly', 'cryptically', 'culturally', 'cumulatively',
    'cunningly', 'curiously', 'currently', 'cursorily', 'curtly', 'customarily', 'cutely', 'cyclically', 'cynically', 'daintily',
    'damnably', 'damply', 'dangerously', 'dankly', 'daringly', 'darkly', 'dashingly', 'dauntlessly', 'deadly', 'dearly',
    'debonairly', 'decadently', 'deceitfully', 'decently', 'deceptively', 'decidedly', 'decisively', 'decorously', 'deeply', 'defensively',
    'deferentially', 'defiantly', 'definitely', 'definitively', 'deftly', 'dejectedly', 'deliberately', 'delicately', 'deliciously', 'delightfully',
    'delinquently', 'deliriously', 'dementedly', 'democratically', 'demographically', 'demonstrably', 'demonstratively', 'demurely', 'densely', 'dependably',
    'deplorably', 'depressingly', 'derisively', 'descriptively', 'deservedly', 'desirably', 'desolately', 'despairingly', 'desperately', 'despicably',
    'despondently', 'destructively', 'devilishly', 'deviously', 'devotedly', 'devoutly', 'dexterously', 'dextrously', 'diabolically', 'diagonally',
    'diametrically', 'differently', 'diffidently', 'diffusely', 'digitally', 'diligently', 'dimly', 'diplomatically', 'directly', 'disadvantageously',
    'disagreeably', 'disappointingly', 'disapprovingly', 'disastrously', 'disconnectedly', 'disconsolately', 'discontentedly', 'discouragingly', 'discourteously', 'discreetly',
    'disdainfully', 'disgracefully', 'disgustedly', 'dishonestly', 'dishonorably', 'dishonourably', 'disinterestedly', 'disjointedly', 'disloyally', 'dismally',
    'disobediently', 'disorderly', 'dispassionately', 'disproportionately', 'disreputably', 'disrespectfully', 'dissolutely', 'distantly', 'distastefully', 'distinctively',
    'distinctly', 'distressingly', 'distrustfully', 'diversely', 'divinely', 'divisively', 'dizzily', 'docilely', 'doggedly', 'dogmatically',
    'dolefully', 'domestically', 'dominantly', 'dotingly', 'doubly', 'doubtfully', 'dourly', 'dowdily', 'drably', 'dramatically',
    'drastically', 'dreadfully', 'dreamily', 'drearily', 'drily', 'drizzly', 'drolly', 'drowsily', 'drunkenly', 'dryly',
    'dubiously', 'dully', 'duly', 'dumbly', 'durably', 'dutifully', 'dynamically', 'eagerly', 'earnestly', 'easily',
    'eccentrically', 'eclectically', 'ecologically', 'economically', 'ecstatically', 'ecumenically', 'editorially', 'educationally', 'eerily', 'effectively',
    'effectually', 'efficaciously', 'efficiently', 'effortlessly', 'effusively', 'egotistically', 'egregiously', 'elaborately', 'electrically', 'electronically',
    'elegantly', 'elliptically', 'eloquently', 'elusively', 'embarrassingly', 'eminently', 'emotionally', 'empirically', 'emptily', 'encouragingly',
    'endearingly', 'endlessly', 'energetically', 'engagingly', 'enigmatically', 'enormously', 'entertainingly', 'enthusiastically', 'entirely', 'enviably',
    'enviously', 'environmentally', 'equably', 'equally', 'equitably', 'equivalently', 'equivocally', 'erectly', 'erratically', 'erroneously',
    'eruditely', 'esoterically', 'especially', 'essentially', 'eternally', 'ethereally', 'ethically', 'ethnically', 'euphemistically', 'evasively',
    'evenly', 'eventfully', 'eventually', 'evidently', 'evilly', 'exactingly', 'exactly', 'exceedingly', 'excellently', 'exceptionally',
    'excessively', 'excitedly', 'excitingly', 'exclusively', 'excruciatingly', 'exhaustively', 'existentially', 'exorbitantly', 'exotically', 'expansively',
    'expectantly', 'expediently', 'expeditiously', 'expensively', 'experimentally', 'expertly', 'explicitly', 'explosively', 'exponentially', 'expressively',
    'expressly', 'exquisitely', 'extemporaneously', 'extensively', 'externally', 'extraneously', 'extraordinarily', 'extravagantly', 'extremely', 'extrinsically',
    'exuberantly', 'exultantly', 'fabulously', 'facetiously', 'facially', 'factually', 'faintly', 'fairly', 'faithfully', 'faithlessly',
    'fallaciously', 'fallibly', 'falsely', 'falteringly', 'familiarly', 'famously', 'fanatically', 'fancifully', 'fantastically', 'fashionably',
    'fastidiously', 'fatally', 'fatefully', 'fatuously', 'faultily', 'faultlessly', 'favorably', 'favourably', 'fearfully', 'fearlessly',
    'feasibly', 'federally', 'feebly', 'feelingly', 'ferociously', 'fervently', 'fervidly', 'festively', 'fetchingly', 'feverishly',
    'fiendishly', 'fiercely', 'figuratively', 'finally', 'financially', 'finely', 'finitely', 'firmly', 'firstly', 'fiscally',
    'fitfully', 'fitly', 'fittingly', 'fixedly', 'flagrantly', 'flamboyantly', 'flashily', 'flatly', 'flatteringly', 'flawlessly',
    'flexibly', 'flimsily', 'flippantly', 'flirtatiously', 'floridly', 'fluently', 'fluidly', 'fondly', 'foolishly', 'forbiddingly',
    'forcefully', 'forcibly', 'forgetfully', 'forlornly', 'formally', 'formerly', 'formidably', 'formlessly', 'fortunately', 'foully',
    'fourthly', 'fractionally', 'fractiously', 'fragrantly', 'frankly', 'frantically', 'fraternally', 'fraudulently', 'freely', 'frenetically',
    'frenziedly', 'freshly', 'fretfully', 'frighteningly', 'frightfully', 'frigidly', 'friskily', 'frivolously', 'frontally', 'frostily',
    'frugally', 'fruitfully', 'fruitlessly', 'fully', 'functionally', 'fundamentally', 'funereally', 'funnily', 'furiously', 'furtively',
    'fussily', 'futilely', 'fuzzily', 'gaily', 'gainfully', 'gallantly', 'gamely', 'garishly', 'garrulously', 'gaudily',
    'gawkily', 'generally', 'generically', 'generously', 'genetically', 'genially', 'gently', 'genuinely', 'geographically', 'geologically',
    'geometrically', 'ghastly', 'giddily', 'gingerly', 'girlishly', 'glacially', 'gladly', 'glamorously', 'glaringly', 'gleefully',
    'glibly', 'globally', 'gloomily', 'gloriously', 'glowingly', 'glumly', 'gluttonously', 'gorgeously', 'gracefully', 'gracelessly',
    'graciously', 'gradually', 'grammatically', 'grandly', 'graphically', 'gratefully', 'gratuitously', 'gravely', 'greatly', 'greedily',
    'gregariously', 'grievously', 'grimly', 'groggily', 'grossly', 'grotesquely', 'groundlessly', 'grudgingly', 'gruesomely', 'gruffly',
    'grumpily', 'guardedly', 'guiltily', 'habitually', 'halfheartedly', 'haltingly', 'handily', 'handsomely', 'haphazardly', 'happily',
    'hardheadedly', 'hardheartedly', 'hardily', 'hardly', 'harmfully', 'harmlessly', 'harmonically', 'harmoniously', 'harshly', 'hastily',
    'hatefully', 'haughtily', 'hauntingly', 'hazily', 'healthfully', 'healthily', 'heartily', 'heartlessly', 'heatedly', 'heavily',
    'hectically', 'heedlessly', 'heinously', 'hellishly', 'helpfully', 'helplessly', 'hermetically', 'heroically', 'hesitantly', 'hesitatingly',
    'hideously', 'hierarchically', 'highly', 'hilariously', 'historically', 'hoarsely', 'hollowly', 'homogeneously', 'honestly', 'honorably',
    'honourably', 'hopefully', 'hopelessly', 'horizontally', 'horrendously', 'horribly', 'horridly', 'hospitably', 'hostilely', 'hotheadedly',
    'hotly', 'huffily', 'hugely', 'humanely', 'humanly', 'humbly', 'humorously', 'hungrily', 'hurriedly', 'huskily',
    'hydraulically', 'hygienically', 'hypercritically', 'hypnotically', 'hypocritically', 'hypothetically', 'hysterically', 'icily', 'idealistically', 'ideally',
    'identically', 'ideologically', 'idiomatically', 'idiotically', 'idly', 'ignobly', 'ignominiously', 'ignorantly', 'illegally', 'illegibly',
    'illegitimately', 'illicitly', 'illogically', 'imaginably', 'imaginatively', 'immaculately', 'immaturely', 'immeasurably', 'immediately', 'immensely',
    'imminently', 'immoderately', 'immodestly', 'immorally', 'immortally', 'immovably', 'immutably', 'impartially', 'impassively', 'impatiently',
    'impeccably', 'impenetrably', 'imperatively', 'imperceptibly', 'imperfectly', 'imperially', 'imperiously', 'impersonally', 'impertinently', 'imperturbably',
    'impetuously', 'impiously', 'impishly', 'implacably', 'implausibly', 'implicitly', 'impolitely', 'importantly', 'imposingly', 'impossibly',
    'impotently', 'impracticably', 'imprecisely', 'impregnably', 'impressively', 'improbably', 'improperly', 'improvidently', 'impudently', 'impulsively',
    'impurely', 'inaccurately', 'inadequately', 'inadvertently', 'inanely', 'inappropriately', 'inarticulately', 'inaudibly', 'incalculably', 'incidentally',
    'incisively', 'inclusively', 'incoherently', 'incomparably', 'incompatibly', 'incompetently', 'incompletely', 'incomprehensibly', 'inconceivably', 'inconclusively',
    'incongruously', 'inconsequentially', 'inconsiderately', 'inconsistently', 'inconspicuously', 'incontestably', 'incontrovertibly', 'inconveniently', 'incorrectly', 'incorrigibly',
    'increasingly', 'incredibly', 'incredulously', 'incurably', 'indecently', 'indecisively', 'indefatigably', 'indefensibly', 'indefinably', 'indefinitely',
    'indelibly', 'indelicately', 'independently', 'indescribably', 'indestructibly', 'indeterminately', 'indifferently', 'indignantly', 'indirectly', 'indiscreetly',
    'indiscriminately', 'indispensably', 'indisputably', 'indistinctly', 'individually', 'indivisibly', 'indolently', 'indomitably', 'indubitably', 'indulgently',
    'industrially', 'industriously', 'ineffably', 'ineffectively', 'ineffectually', 'inefficiently', 'inelegantly', 'ineluctably', 'ineptly', 'inertly',
    'inescapably', 'inestimably', 'inevitably', 'inexcusably', 'inexhaustibly', 'inexorably', 'inexpensively', 'inexplicably', 'inextricably', 'infallibly',
    'infamously', 'infectiously', 'infinitely', 'infinitesimally', 'inflexibly', 'influentially', 'informally', 'infuriatingly', 'ingeniously', 'ingenuously',
    'ingratiatingly', 'inherently', 'inhumanely', 'inhumanly', 'inimically', 'inimitably', 'initially', 'innately', 'innocently', 'innocuously',
    'inoffensively', 'inordinately', 'inquiringly', 'inquisitively', 'insanely', 'insatiably', 'inscrutably', 'insecurely', 'insensibly', 'inseparably',
    'insidiously', 'insignificantly', 'insincerely', 'insistently', 'insolently', 'instantaneously', 'instantly', 'instinctively', 'instructively', 'insufferably',
    'insufficiently', 'intangibly', 'intellectually', 'intelligently', 'intelligibly', 'intensely', 'intensively', 'intentionally', 'intently', 'interchangeably',
    'interestingly', 'interminably', 'intermittently', 'internally', 'internationally', 'intimately', 'intolerably', 'intransitively', 'intravenously', 'intrepidly',
    'intricately', 'intriguingly', 'intrinsically', 'intuitively', 'invariably', 'inversely', 'invidiously', 'invincibly', 'invisibly', 'invitingly',
    'involuntarily', 'invulnerably', 'inwardly', 'irately', 'ironically', 'irrationally', 'irregularly', 'irrelevantly', 'irremediably', 'irreparably',
    'irresistibly', 'irresolutely', 'irresponsibly', 'irretrievably', 'irreverently', 'irreversibly', 'irrevocably', 'irritably', 'irritatingly', 'jaggedly',
    'jauntily', 'jealously', 'jeeringly', 'jerkily', 'jocosely', 'jocularly', 'jocundly', 'jointly', 'jokingly', 'jolly',
    'jovially', 'joyfully', 'joyously', 'jubilantly', 'judicially', 'judiciously', 'juicily', 'justifiably', 'justly', 'keenly',
    'kindly', 'kingly', 'knowingly', 'knowledgeably', 'laboriously', 'lackadaisically', 'laconically', 'lamely', 'lamentably', 'languidly',
    'languorously', 'largely', 'lasciviously', 'lastingly', 'lastly', 'lately', 'laterally', 'latterly', 'laudably', 'laughably',
    'laughingly', 'lavishly', 'lawfully', 'lawlessly', 'laxly', 'lazily', 'lecherously', 'legally', 'legibly', 'legitimately',
    'leisurely', 'lengthily', 'leniently', 'lethally', 'lethargically', 'lewdly', 'liberally', 'licentiously', 'lightheartedly', 'lightly',
    'likely', 'limpidly', 'limply', 'lineally', 'linearly', 'lingeringly', 'listlessly', 'literally', 'lively', 'lividly',
    'locally', 'loftily', 'logically', 'logistically', 'longingly', 'longitudinally', 'loosely', 'lopsidedly', 'lordly', 'loudly',
    'lovingly', 'loyally', 'lucidly', 'luckily', 'lucratively', 'ludicrously', 'lugubriously', 'luminously', 'luridly', 'lusciously',
    'lustfully', 'lustily', 'luxuriantly', 'luxuriously', 'lyrically', 'madly', 'magically', 'magisterially', 'magnetically', 'magnificently',
    'mainly', 'majestically', 'malevolently', 'maliciously', 'malignantly', 'manfully', 'manly', 'mannerly', 'mannishly', 'manually',
    'markedly', 'marvellously', 'marvelously', 'massively', 'masterfully', 'materially', 'maternally', 'mathematically', 'maturely', 'mawkishly',
    'maximally', 'meagerly', 'meaningfully', 'meanly', 'measurably', 'mechanically', 'meditatively', 'meekly', 'mellifluously', 'melodically',
    'melodiously', 'melodramatically', 'memorably', 'menacingly', 'menially', 'mentally', 'mercifully', 'mercilessly', 'merely', 'meritoriously',
    'messily', 'metaphorically', 'methodically', 'meticulously', 'metrically', 'mightily', 'mildly', 'militantly', 'militarily', 'mindfully',
    'mindlessly', 'minimally', 'minutely', 'miraculously', 'mirthfully', 'mischievously', 'miserably', 'misguidedly', 'mistakenly', 'moderately',
    'modestly', 'modishly', 'moistly', 'monetarily', 'monotonically', 'monotonously', 'monstrously', 'monumentally', 'moodily', 'morosely',
    'mortally', 'mostly', 'mulishly', 'mundanely', 'municipally', 'murderously', 'musically', 'mutinously', 'mutually', 'mysteriously',
    'mystically', 'naively', 'nakedly', 'namely', 'narrowly', 'nasally', 'nastily', 'nationally', 'nattily', 'naturally',
    'naughtily', 'nauseatingly', 'nautically', 'nearly', 'neatly', 'necessarily', 'nefariously', 'negatively', 'neglectfully', 'negligently',
    'negligibly', 'nervelessly', 'nervously', 'neurotically', 'neutrally', 'newly', 'nicely', 'nimbly', 'noiselessly', 'noisily',
    'nonchalantly', 'nonsensically', 'normally', 'nostalgically', 'notably', 'notionally', 'notoriously', 'numbly', 'numerically', 'obediently',
    'objectionably', 'objectively', 'obligingly', 'obliquely', 'obliviously', 'obnoxiously', 'obscurely', 'observably', 'observantly', 'obstinately',
    'obstructively', 'obtrusively', 'oddly', 'odiously', 'offensively', 'officially', 'officiously', 'ominously', 'only', 'opaquely',
    'oppressively', 'optimistically', 'optionally', 'orally', 'orderly', 'ordinarily', 'organically', 'originally', 'ornately', 'ostensibly',
    'ostentatiously', 'outlandishly', 'outrageously', 'outspokenly', 'outwardly', 'overly', 'overtly', 'overwhelmingly', 'pacifically', 'painfully',
    'painstakingly', 'palpably', 'paradoxically', 'parenthetically', 'particularly', 'partly', 'passably', 'passionately', 'patently', 'paternally',
    'pathetically', 'pathologically', 'patiently', 'patriotically', 'patronisingly', 'peaceably', 'peacefully', 'peculiarly', 'pedantically', 'peevishly',
    'penitently', 'perceptibly', 'perceptively', 'perfectly', 'perfunctorily', 'perilously', 'permanently', 'permissibly', 'permissively', 'perniciously',
    'perpetually', 'persistently', 'personally', 'persuasively', 'pertly', 'perversely', 'petulantly', 'phenomenally', 'philanthropically', 'philosophically',
    'phlegmatically', 'photographically', 'physically', 'pictorially', 'piercingly', 'piously', 'pithily', 'pitiably', 'pitifully', 'pitilessly',
    'placidly', 'plainly', 'plaintively', 'playfully', 'pleasingly', 'pleasurably', 'plentifully', 'pneumatically', 'poetically', 'poignantly',
    'pointedly', 'pointlessly', 'politely', 'pompously', 'ponderously', 'poorly', 'popularly', 'portentously', 'positively', 'possibly',
    'posthumously', 'powerfully', 'powerlessly', 'practically', 'pragmatically', 'precariously', 'preciously', 'precipitately', 'precipitously', 'precisely',
    'precociously', 'predictably', 'preferably', 'preferentially', 'prematurely', 'preposterously', 'presently', 'presumably', 'presumptuously', 'prettily',
    'primarily', 'primitively', 'primly', 'princely', 'principally', 'privately', 'probably', 'prodigiously', 'productively', 'profanely',
    'professionally', 'proficiently', 'profitably', 'profoundly', 'profusely', 'progressively', 'prohibitively', 'promiscuously', 'promptly', 'properly',
    'prophetically', 'proportionately', 'prosaically', 'protectively', 'proudly', 'provably', 'proverbially', 'providentially', 'providently', 'provisionally',
    'provocatively', 'prudently', 'prudishly', 'psychically', 'psychologically', 'publicly', 'pugnaciously', 'punctiliously', 'punctually', 'pungently',
    'purely', 'puritanically', 'purposely', 'quaintly', 'qualitatively', 'queasily', 'queenly', 'questionably', 'questioningly', 'quickly',
    'quietly', 'quizzically', 'racially', 'racily', 'radiantly', 'radically', 'raggedly', 'rakishly', 'rampantly', 'rancorously',
    'randomly', 'rapaciously', 'rapidly', 'rarely', 'rascally', 'rashly', 'rationally', 'raucously', 'ravenously', 'ravishingly',
    'readily', 'realistically', 'really', 'reasonably', 'reassuringly', 'rebelliously', 'reciprocally', 'recognizably', 'redundantly', 'reflexively',
    'refreshingly', 'regally', 'regionally', 'regretfully', 'regrettably', 'regularly', 'relentlessly', 'relevantly', 'reliably', 'religiously',
    'reluctantly', 'remorsefully', 'remorselessly', 'remotely', 'repeatedly', 'reportedly', 'reprehensibly', 'reproachfully', 'repulsively', 'reputably',
    'reputedly', 'resentfully', 'reservedly', 'resolutely', 'resonantly', 'resoundingly', 'resourcefully', 'respectfully', 'respectively', 'responsibly',
    'responsively', 'restfully', 'restively', 'restlessly', 'restrictively', 'retrospectively', 'revoltingly', 'richly', 'ridiculously', 'righteously',
    'rightfully', 'rightly', 'ripely', 'ritually', 'robustly', 'roguishly', 'romantically', 'rosily', 'roughly', 'roundly',
    'routinely', 'royally', 'rudely', 'ruggedly', 'ruinously', 'rustically', 'ruthlessly', 'sadistically', 'sadly', 'safely',
    'salaciously', 'sanctimoniously', 'sanely', 'sarcastically', 'sardonically', 'sartorially', 'satanically', 'satirically', 'satisfactorily', 'savagely',
    'scandalously', 'scantily', 'scarcely', 'sceptically', 'schematically', 'scholastically', 'scornfully', 'scrupulously', 'scurrilously', 'searchingly',
    'securely', 'sedately', 'seductively', 'seemly', 'selectively', 'selfishly', 'selflessly', 'semantically', 'sensationally', 'senselessly',
    'sensibly', 'sensitively', 'sensually', 'separately', 'sequentially', 'serenely', 'serially', 'seriously', 'severally', 'severely',
    'sexily', 'shabbily', 'shamelessly', 'shapelessly', 'sharply', 'sheepishly', 'shiftily', 'shockingly', 'shoddily', 'shortly',
    'shortsightedly', 'showily', 'shrewdly', 'shrilly', 'shyly', 'sickeningly', 'sickly', 'signally', 'silently', 'similarly',
    'simply', 'simultaneously', 'sincerely', 'sinfully', 'singly', 'singularly', 'skilfully', 'skillfully', 'slackly', 'slavishly',
    'sleazily', 'sleepily', 'slickly', 'slightly', 'slily', 'sloppily', 'slovenly', 'slowly', 'sluggishly', 'slyly',
    'smartly', 'smoothly', 'smugly', 'sneeringly', 'snugly', 'soberly', 'sociably', 'softly', 'solely', 'solemnly',
    'solidly', 'somberly', 'sombrely', 'soothingly', 'sorely', 'sorrowfully', 'soulfully', 'soundlessly', 'soundly', 'sourly',
    'spaciously', 'sparely', 'sparingly', 'sparsely', 'spasmodically', 'spatially', 'specially', 'speciously', 'spectacularly', 'speedily',
    'spirally', 'spitefully', 'splendidly', 'spontaneously', 'sporadically', 'spotlessly', 'sprightly', 'spryly', 'spuriously', 'squarely',
    'squeamishly', 'staggeringly', 'staidly', 'starkly', 'startlingly', 'stately', 'statically', 'statistically', 'steadfastly', 'steadily',
    'stealthily', 'stiffly', 'stingily', 'stonily', 'stoutly', 'straightforwardly', 'strangely', 'strenuously', 'strictly', 'stringently',
    'structurally', 'stubbornly', 'studiously', 'stuffily', 'stupendously', 'stupidly', 'sturdily', 'stylistically', 'subconsciously', 'subjectively',
    'sublimely', 'subliminally', 'subsequently', 'substantially', 'subtly', 'successfully', 'successively', 'succinctly', 'suddenly', 'suggestively',
    'suitably', 'sullenly', 'summarily', 'superbly', 'superficially', 'superlatively', 'supposedly', 'supremely', 'surely', 'surgically',
    'surprisingly', 'suspiciously', 'sweetly', 'swiftly', 'symbolically', 'symmetrically', 'synchronously', 'syntactically', 'tacitly', 'tactically',
    'tactlessly', 'tangibly', 'tantalisingly', 'tantalizingly', 'tartly', 'tastefully', 'tastelessly', 'tearfully', 'technically', 'technologically',
    'telepathically', 'tellingly', 'tempestuously', 'temporally', 'temptingly', 'tendentiously', 'tenderly', 'tensely', 'tenuously', 'terribly',
    'terrifically', 'terrifyingly', 'tersely', 'thankfully', 'thanklessly', 'theatrically', 'thematically', 'therapeutically', 'thermally', 'thickly',
    'thinly', 'thirdly', 'thoroughly', 'thoughtlessly', 'threateningly', 'thriftily', 'throatily', 'thunderously', 'tidily', 'timidly',
    'timorously', 'tipsily', 'tirelessly', 'tolerably', 'topically', 'topologically', 'tortuously', 'totally', 'touchingly', 'toughly',
    'tragically', 'tranquilly', 'transcendentally', 'transitively', 'transparently', 'treacherously', 'tremendously', 'tremulously', 'trenchantly', 'trimly',
    'triply', 'triumphantly', 'trivially', 'truculently', 'truly', 'tunefully', 'tunelessly', 'turbulently', 'turgidly', 'typically',
    ...
    'understandingly', 'undeservedly', 'undoubtedly', 'unduly', 'uneasily', 'unequally', 'unequivocally', 'unerringly', 'unevenly', 'uneventfully',
    'unexpectedly', 'unfailingly', 'unfaithfully', 'unfavorably', 'unfavourably', 'unfeelingly', 'unflinchingly', 'unfortunately', 'unfriendly', 'ungainly',
    'ungratefully', 'unhesitatingly', 'uniformly', 'unilaterally', 'unintelligibly', 'unintentionally', 'universally', 'unjustly', 'unknowingly', 'unlawfully',
    'unluckily', 'unmanly', 'unmannerly', 'unmercifully', 'unmistakably', 'unnaturally', 'unnecessarily', 'unobtrusively', 'unofficially', 'unquestionably',
    'unrealistically', 'unreasonably', 'unrelentingly', 'unreservedly', 'unscrupulously', 'unseasonably', 'unseemly', 'unselfishly', 'unspeakably', 'unsuccessfully',
    'unthinkingly', 'untiringly', 'untruthfully', 'unusually', 'unutterably', 'unwillingly', 'unwisely', 'unwittingly', 'uproariously', 'upwardly',
    'usefully', 'uselessly', 'usually', 'vacantly', 'vacuously', 'vaguely', 'vainly', 'valiantly', 'validly', 'variably',
    'vastly', 'vehemently', 'venally', 'vengefully', 'verbally', 'verily', 'veritably', 'vertically', 'vibrantly', 'vicariously',
    'victoriously', 'vigilantly', 'vigorously', 'vilely', 'vindictively', 'virtually', 'virtuously', 'virulently', 'visually', 'vitally',
    'vivaciously', 'vividly', 'vocally', 'vociferously', 'voluminously', 'voluntarily', 'voraciously', 'vulgarly', 'warily', 'warmly',
    'watchfully', 'weakly', 'wearily', 'whimsically', 'wholeheartedly', 'wholly', 'widely', 'wildly', 'wilfully', 'willingly',
    'winsomely', 'wishfully', 'wistfully', 'witlessly', 'wittily', 'wittingly', 'woefully', 'wonderfully', 'wondrously', 'woodenly',
    'worldly', 'worthily', 'wretchedly', 'wrongfully', 'wrongheadedly', 'wrongly', 'wryly', 'youthfully', 'zealously', 'zestfully'
  ],
  place: [
